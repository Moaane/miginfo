...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border border-neutral-200 px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-neutral-950 focus:ring-offset-2 dark:border-neutral-800 dark:focus:ring-neutral-300",
  {
    variants: {
      variant: {
        default:
          "border-transparent bg-primary text-neutral-50 hover:bg-primary/80 dark:bg-neutral-50 dark:text-primary dark:hover:bg-neutral-50/80",
        secondary:
        ...
        outline:
          "text-neutral-950 dark:text-neutral-50 hover:bg-primary/80 hover:text-white",
        success:
          "border-transparent bg-green-700 text-neutral-50 hover:bg-green-700/80 dark:bg-neutral-50 dark:text-primary dark:hover:bg-neutral-50/80",
      },
    },
    defaultVariants: {
      variant: "default",
