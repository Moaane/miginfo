...
import ApplicationMenu from "@/components/dashboard/menu/ApplicationMenu";
...
export default function Page() {
  ...
  async function fetchApplications(page) {
    try {
      setLoading(true);
      const response = await fetch(`/api/application?page=${page}`, {
        method: "GET",
      });
      ...
      console.log("Error while getting applications");
    } finally {
      setLoading(false);
    }
  }
  ...
  useEffect(() => {
    fetchApplications(meta.currentPage);
  }, [meta.currentPage]);
  return (
    <>
