...
export default function Page() {
  ...
  async function fetchServices(page) {
    ...
    const res = await fetch(
      `../../api/services?page=${page}&perPage=${meta.perPage}`,
      {
        method: "GET",
      }
    );
                    ...
                    <TableBody>
                      {data?.map((prop, index) => (
                        <TableRow
                          key={prop.id}
                          onClick={() =>
                            router.push(`services/lists/${prop.id}`)
                          }
                        >
                          ...
                          <TableCell>
                            <Badge
                              variant={
                                prop.onSection ? "default" : "destructive"
                              }
                            >
                          ...
                          <TableCell>
                            <Badge
                              variant={prop.status ? "success" : "destructive"}
                            >
                          ...
                          <TableCell>
                            <DropdownMenu>
                              ...
                              <DropdownMenuContent align="end">
                                ...
                                >
                                  <Link href={`services/update/${prop.id}`} className="z-20">
                                    Update
                                  </Link>
                                </DropdownMenuItem>
                                <DropdownMenuItem
