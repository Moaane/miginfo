    ...
    <div ref={container}>
      ...
      <div className="hero bg-white lg:min-h-[480px] text-black xl:px-24 lg:px-16 md:px-12 px-4">
        <div className="hero-content flex-col lg:flex-row-reverse space-y-4 md:space-y-4 px-0 2xl:min-w-[1440px]">
          ...
          <div className="c lg:w-1/2 flex w-full justify-center lg:justify-start">
            <img
              src="/img_holder.png"
              className="max-w-64 md:max-w-sm 2xl:max-w-lg w-full rounded-xl shadow-2xl"
            />
      ...
      <div className="hero values bg-white lg:min-h-[480px] text-black xl:px-24 lg:px-16 md:px-12 px-4">
        <div className="hero-content flex-col lg:flex-row space-y-4 md:space-y-4 px-0 2xl:min-w-[1440px]">
          <div className="v lg:w-1/2">
            <h1 className="text-xl text-primary md:text-3xl xl:text-4xl 2xl:text-5xl font-semibold">
              Our Values
            </h1>
            <p className="text-sm py-2 pb-4 md:py-4 xl:text-lg leading-loose">
              ICT Solutions' experienced management understands client
              expectations and ensures prompt issue resolution. We deliver top
              solutions with highly qualified teams, maintaining constant
              communication and availability.
            </p>
          </div>
          <div className="v lg:w-1/2 flex w-full justify-center lg:justify-end">
            <img
              src="/img_holder.png"
              className="max-w-64 md:max-w-sm w-full rounded-xl shadow-2xl"
            />
          </div>
        </div>
      </div>

      <div className="hero teams bg-white service xl:min-h-[600px] lg:min-h-[480px] text-black xl:px-24 lg:px-16 md:px-8 px-2 pt-6">
        <div className="hero-content flex-col h-full justify-start w-full md:space-y-4 px-0 gap-8">
          <h1 className="t text-2xl md:text-4xl text-primary font-semibold">
            Our Teams
          </h1>
          <div className="grid justify-items-center grid-cols-1 md:grid-cols-3 md:gap-x-0 gap-6 w-full gap-y-12 pb-6 2xl:min-w-[1440px]">
            {users?.map((user, index) => (
              <div
                key={index}
                className="card t max-w-64 w-full h-full md:w-52 xl:max-w-80 2xl:max-w-96 lg:w-full shadow-xl"
              >
